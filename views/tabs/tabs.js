export class Tabs {
  ...
  updateActiveTab() {
    ...
    const baseClass = "tab-button w-40 sm:w-48 px-[1.73rem] sm:px-[2.59rem] py-[1.3rem] sm:py-[1.51rem] text-[1.73rem] sm:text-[1.94rem] rounded-lg transition-colors duration-200 min-h-[89px] sm:min-h-[96px] flex items-center justify-center box-border font-medium";
