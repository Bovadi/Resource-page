    ...
    actions: [
      {
        ...
        variant: 'primary',
        badge: null,
        tooltip: 'Auto-generate a behavior intervention plan from your data',
      ...
      },
      {
        ...
        tooltip: 'Start a new BIP using the updated template',
        icon: `<svg class="w-5 h-5 flex-shrink-0" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1" stroke-linecap="round" stroke-linejoin="round">
      ...
      },
      {
        ...
        tooltip: 'Start a new BIP using the original template',
        icon: `<svg class="w-5 h-5 flex-shrink-0" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1" stroke-linecap="round" stroke-linejoin="round">
          <line x1="12" y1="5" x2="12" y2="19"/><line x1="5" y1="12" x2="19" y2="12"/>
        </svg>`
      }
    ...
    actions: [
      {
        ...
        variant: 'primary',
        badge: null,
        tooltip: 'Upload a PDF, video, or worksheet to share',
        icon: `<svg class="w-5 h-5 flex-shrink-0" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1" stroke-linecap="round" stroke-linejoin="round">
      ...
      },
      {
        ...
        variant: 'outline',
        badge: null,
        tooltip: 'Browse the full resource library',
        icon: `<svg class="w-5 h-5 flex-shrink-0" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1" stroke-linecap="round" stroke-linejoin="round">
    ...
    actions: [
      {
        ...
        variant: 'primary',
        badge: null,
        tooltip: 'Browse available courses and enroll',
        icon: `<svg class="w-5 h-5 flex-shrink-0" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1" stroke-linecap="round" stroke-linejoin="round">
      ...
      },
      {
        ...
        variant: 'outline',
        badge: null,
        tooltip: 'View your enrolled and completed courses',
        icon: `<svg class="w-5 h-5 flex-shrink-0" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1" stroke-linecap="round" stroke-linejoin="round">
    ...
    actions: [
      {
        ...
        variant: 'primary',
        badge: null,
        tooltip: 'Build a new behavior intervention strategy',
        icon: `<svg class="w-5 h-5 flex-shrink-0" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1" stroke-linecap="round" stroke-linejoin="round">
          <line x1="12" y1="5" x2="12" y2="19"/><line x1="5" y1="12" x2="19" y2="12"/>
        </svg>`
      },
